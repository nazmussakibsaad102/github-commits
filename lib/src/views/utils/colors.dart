...
// Secondary color
const Color kBlueColor = Color(0xFF0A84FF);
const Color kDarkBlueColor = Color(0xAA0A84FF);

// Grey color
const Color kGreyColor = Color(0xFF9B9B9B);
const Color kDarkGreyColor = Color(0xFF515050);
const Color kLightGreyColor = Color(0xFFB8B8B8);