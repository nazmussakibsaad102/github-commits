...
const TextStyle kTitleTextStyle =
    TextStyle(fontSize: 17.0, color: kWhiteColor, fontFamily: "Roboto");
const TextStyle kLargeTitleTextStyle =
    TextStyle(fontSize: 24.0, color: kWhiteColor, fontFamily: "SourceSansPro");
